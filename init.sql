...
INSERT INTO shop.products (name, description, price, image_url, stock, category_id, status) VALUES
    ...
    ('D4 智能床头灯',          '无极调光，触控+语音双控，定时关灯，柔光护眼',                   199.00, '',     50, 13, 'on_sale'),
    ('Z1 智能电动窗帘电机',    '静音电机，支持手拉启动，定时开合，语音控制',                    699.00, '',     20, 14, 'on_sale'),
    ('Z2 智能卷帘电机',        '适合卷帘/百叶窗，内置锂电池，免布线安装',                       499.00, '',     25, 14, 'on_sale'),
    ('T1 门窗传感器',          '即时感知门窗开关，低功耗设计，纽扣电池续航2年',                  99.00, '',     100, 15, 'on_sale'),
    ('T2 人体移动传感器',      '红外人体移动检测，110°广角，光照度感应，休眠唤醒',             129.00, '',     60, 16, 'on_sale'),
    ('T3 温湿度传感器',        '高精度温湿度监测，±0.2℃精度，联动空调/加湿器',                149.00, '',     40, 16, 'on_sale'),
    ('T4 水浸传感器',          '0.5mm浸水感应，IP67防尘防水，联动关阀，厨房卫生间必备',         79.00, '',     55, 15, 'on_sale'),
    ('T5 烟雾报警器',          '光电式烟雾探测，85分贝声光报警，APP远程提醒',                   169.00, '',     35, 16, 'on_sale'),
    ('P1 网关电源适配器',      '12V/2A电源适配器，兼容G1/G2系列网关',                           59.00, '',     100, 11, 'on_sale'),
